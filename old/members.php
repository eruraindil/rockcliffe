...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			...
			<div class='attention' style='color:#C00'><span>Coming Soon</span></div>
			<form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
			<table><tr>
				<td>Email: </td>
				<td><input type="text" name="username" size="30" maxlength="50" disabled="disabled" /></td>
			</tr><tr>
				<td>Password: </td>
				<td><input type="password" name="pass" size="30" maxlength="50" disabled="disabled" /></td>
			</tr><tr>
				<td>&nbsp;</td>
				<td colspan="2" style="text-align:right;padding-bottom:20px"><span id="results"></span><input type="submit" name="submit" value="Login" disabled="disabled" /></td>
			</tr></table>
			</form>
			</div>
